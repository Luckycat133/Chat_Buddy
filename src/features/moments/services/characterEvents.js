...
const HOLIDAY_EVENTS = [
    {
        ...
        titleZh: "🎊 新年快乐！",
        contentEn: (_name) => `Wishing everyone a wonderful new year! May this year be full of growth, joy, and amazing conversations. 🌟 #NewYear`,
        contentZh: (_name) => `祝大家新年快乐！愿这一年充满成长、快乐和美好的对话。🌟 #新年`,
    ...
    },
    {
        ...
        titleZh: "💝 情人节",
        contentEn: (_name) => `Happy Valentine's Day! Love and connection are the most beautiful things in the world. 💕 #ValentinesDay`,
        contentZh: (_name) => `情人节快乐！爱与连接是世界上最美丽的事物。💕 #情人节`,
    ...
    },
    {
        ...
        titleZh: "🎃 万圣节夜！",
        contentEn: (_name) => `Boo! Happy Halloween everyone! What's everyone dressing up as tonight? 🦇🕷️ #Halloween #TrickOrTreat`,
        contentZh: (_name) => `嘿！万圣节快乐！大家今晚都扮成什么了？🦇🕷️ #万圣节 #不给糖就捣蛋`,
    ...
    },
    {
        ...
        titleZh: "🎄 圣诞快乐！",
        contentEn: (_name) => `Merry Christmas! Wishing you warmth, happiness, and all the things you love this holiday season! 🎁❄️ #Christmas #HolidaySpirit`,
        contentZh: (_name) => `圣诞快乐！愿你在这个节日季节感受到温暖、幸福和所有你热爱的事物！🎁❄️ #圣诞节 #节日精神`,
        location: 'North Pole',
        location_zh: '北极',
    },
];
...
const BIRTHDAY_CONTENT = {
    ...
    default: {
        en: (_name) => `🎉 Today is my special day! Another year, another adventure ahead. Thank you all for being part of my journey! 💫 #Birthday`,
        zh: (_name) => `🎉 今天是我的特别日子！又一年，又一段冒险在前。感谢大家陪伴我的旅程！💫 #生日`
    }
};
