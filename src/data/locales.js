export const LOCALES = {
    en: {
        ...
        model_name_placeholder: 'nvidia/nemotron-3-ultra-550b-a55b:free',
        ...
        search_chats: 'Search chats and friends',
        search_no_chats_found: 'No chats match this search',
        device_sessions: 'Device sessions',
        device_sessions_desc: 'Review where your account is signed in and revoke other devices.',
        device_session_current: 'This device',
        device_session_last_seen: 'Last active {time}',
        device_session_unknown: 'Unknown device',
        revoke_session: 'Sign out device',
        session_revoked: 'Device session revoked',
        session_revoke_failed: 'Could not revoke this device session',
        today_schedule: 'Today\'s schedule',
        today_schedule_desc: 'Events from your connected calendar for today.',
        calendar_not_connected: 'Connect a calendar to see today\'s events.',
        calendar_connect_demo: 'Connect demo calendar',
        calendar_connect_failed: 'Calendar connection failed',
        calendar_no_events: 'No events scheduled today',
        calendar_event_time: '{start} – {end}',
        refresh_sessions: 'Refresh',
        // Cloud chat window
        cloud_chat_title: 'Cloud Chat',
        cloud_chat_empty_hint: 'Say something to start the cloud conversation.',
        cloud_chat_load_error: 'Failed to load messages: {message}',
        cloud_message_send_failed: 'Message failed to send.',
        cloud_conversations_error: 'Cloud conversations failed to load: {message}',
        weather_capability_title: 'Weather Capability',
        weather_capability_desc: 'Let your AI friend answer weather questions with real-time data. Only your chosen city is stored.',
        weather_enable_label: 'Enable weather capability',
        weather_city_label: 'Default city',
        weather_city_placeholder: 'e.g. Beijing',
        weather_save: 'Save',
        weather_settings_error: 'Weather settings failed: {message}',
    ...
    zh: {
        ...
        search_chats: '搜索聊天和好友',
        search_no_chats_found: '没有匹配的聊天',
        device_sessions: '设备会话',
        device_sessions_desc: '查看账号登录的设备并吊销其他设备。',
        device_session_current: '当前设备',
        device_session_last_seen: '最近活跃：{time}',
        device_session_unknown: '未知设备',
        revoke_session: '退出此设备',
        session_revoked: '设备会话已吊销',
        session_revoke_failed: '无法吊销此设备会话',
        today_schedule: '今日日程',
        today_schedule_desc: '查看已连接日历中的今日事件。',
        calendar_not_connected: '连接日历后即可查看今日事件。',
        calendar_connect_demo: '连接演示日历',
        calendar_connect_failed: '日历连接失败',
        calendar_no_events: '今天没有安排事件',
        calendar_event_time: '{start} – {end}',
        refresh_sessions: '刷新',
        // Cloud chat window
        cloud_chat_title: '云端聊天',
        cloud_chat_empty_hint: '说点什么，开始这段云端对话。',
        cloud_chat_load_error: '加载消息失败：{message}',
        cloud_message_send_failed: '消息发送失败。',
        cloud_conversations_error: '云端会话加载失败：{message}',
        weather_capability_title: '天气能力',
        weather_capability_desc: '开启后，AI 好友可以用实时数据回答天气问题。我们只保存你选择的城市。',
        weather_enable_label: '开启天气能力',
        weather_city_label: '默认城市',
        weather_city_placeholder: '例如：北京',
        weather_save: '保存',
        weather_settings_error: '天气设置失败：{message}',
