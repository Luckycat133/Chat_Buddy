...
Follow `CLAUDE.md` for repository-specific rules, then use `.agents/SKILLS.md` to select task-specific project Skills. Load only Skills relevant to the current request.
